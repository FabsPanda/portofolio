  ...
  return (
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">Flutter</span> before, but I must admit
        that it still very challenging for me. However I'm{" "}
      ...
      <p>
        ...
        guitar, playing video games, watching movies, and playing basketball.
      </p>
    </motion.section>
  );
}
